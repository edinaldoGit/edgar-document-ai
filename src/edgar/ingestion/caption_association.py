...
def find_table_for_caption(
    ...
    *,
    ...
    if caption.component_type != ComponentType.TABLE_CAPTION:
        raise ValueError("Component must be a table caption.")
    ...
    for component in components:
        ...
        if component.bbox.y1 < caption.bbox.y2:
            continue
    ...
    *,
    ...
    for caption in components:
        ...
        if table is not None:
            caption.parent_component_id = table.component_id
